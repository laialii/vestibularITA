            ...
            <form id="loginform" class="form-vertical" method="POST" action="{{ route('login') }}">
              {{ csrf_field() }}
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span>
                            <input type="email" id="email" name="email" placeholder="E-mail" value="{{ old('email') }}" required autofocus />
